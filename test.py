...
with tab3:
    ...
    with col1:
        ...
        st.write('### [/] Fixed/changed full loadout system to an acttual working tab')
    ...
    with col2:
        ...
        st.write('### \'How does the loadout tab work?\' video in third tab (at somepoint)')
with st.sidebar:
