...
import time, os, json, streamlit as st # type: ignore
...
#st.session_state['slot1'] = [f'{slotone_weapon}', f'{slotone_rarity}', f'{slotoneattachment1}', f'{slotoneattachment2}', f'{slotoneattachment4}', '{slotoneattachment4}']; st.session_state['slot2'] = ['item', 'rarity', 'attachment1', 'attachment2', 'attachment3', 'attachment4']; st.session_state['slot3'] = ['item', 'rarity', 'attachment1', 'attachment2', 'attachment3', 'attachment4']; st.session_state['slot4'] = ['item', 'rarity', 'attachment1', 'attachment2', 'attachment3', 'attachment4']; st.session_state['slot5'] = ['item', 'rarity', 'attachment1', 'attachment2', 'attachment3', 'attachment4']
...
slotone_allowed_type=slotone_allowed_item='Disabled'
def Weapon_Slot(slot_name, slot_number, allowed_type, allowed_item):
    selected_weapon=None
    col1, col2, col3, col4 = st.columns(4)
    if slot_number == "1": print(slotone_weapon, slottwo_weapon, slotthree_weapon, slotfour_weapon, slotfive_weapon)
    with col1:
        with st.container(border=True): st.write(f'##### Current slot: :red[{slot_name}]') #\n##### Current item: :green[{current_item}]\n##### Current rarity: :orange[{current_rarity}]')
    with col2: slot = st.selectbox(f'Item type', (item_types), help=f'Weapon type for :rainbow[slot {slot_number}]', placeholder=allowed_type)
    with col3: slot_allowed = st.multiselect('Allowed items', items.get(slot, []), items.get(slot, []), help=f'Allowed items for item type (:rainbow[{slot_name}]).', placeholder=allowed_item)
...
with Customize:
    st.divider()
    slotone, slotone_rarity, slotone_weapon = Weapon_Slot("Slot 1", 1, slotone_allowed_type, slotone_allowed_item)
    slottwo, slottwo_rarity, slottwo_weapon = Weapon_Slot("Slot 2", 2, slottwo_weapon, slottwo_rarity)
    slotthree, slotthree_rarity, slotthree_weapon = Weapon_Slot("Slot 3", 3, slotthree_weapon, slotthree_rarity)
    slotfour, slotfour_rarity, slotfour_weapon = Weapon_Slot("Slot 4", 4, slotfour_weapon, slotfour_rarity)
    slotfive, slotfive_rarity, slotfive_weapon = Weapon_Slot("Slot 5", 5, slotfive_weapon, slotfive_rarity)
